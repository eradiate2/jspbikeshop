...
%>
	...
	<div class="container">
		<form name="addressProfile" action="./processShippingInfo.jsp?cartId=<%=cartId %>" class="form-horizontal" method="post">
			<%-- <input type="hidden" name="cartId" value="<%=request.getParameter("cartId") %>" /> --%>
			
			<%-- <input type="hidden" name="id" value="<%=request.getParameter("id") %>" />
			<input type="hidden" name="pname" value="<%=request.getParameter("pname") %>" />
			<input type="hidden" name="pPrice" value="<%=request.getParameter("pPrice") %>" /> --%>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input id="addressName2" name="addressName2"type="text"class="form-control" />
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-10">
					...
					<input type="button" class="btn btn-primary" value="등록" onclick="Profile()" />
