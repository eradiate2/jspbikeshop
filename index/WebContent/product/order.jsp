...
<script src="${pageContext.request.contextPath}/resource/js/validation.js"></script>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12">
								<a href="#" class="active" id="login-form-link">주문내역</a>
							</div>
							<!-- <div class="col-xs-6">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								...
								<form name="newMember1" action="order1.jsp" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="s_number" id="s_number" tabindex="1" class="form-control" placeholder="주문번호">
									</div>
									<!-- <div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="button" name="login-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="확인" onclick="orderCheck()" />
											</div>
										</div>
									</div>
									<!-- <div class="form-group">
